                                ...
                                <>
                                    ...
                                    {categories.map((category) => (
                                        <DropdownMenuItem
                                            ...
                                            className={`cursor-pointer ${selectedCategory === category ? "bg-accent" : ""
                                                }`}
                                        >
                                            {category}
                                        </DropdownMenuItem>
                            ...
                            <div className="space-y-1 max-h-48 overflow-y-auto">
                                ...
                                {categories.map((category) => (
                                    <Button
                                        key={category}
                                        variant="ghost"
                                        className={`w-full justify-start ${selectedCategory === category ? "bg-accent" : ""
                                            }`}
                                        onClick={() => handleCategorySelect(category)}
                                    >
                                        {category}
                                ...
                                <div className="space-y-1 max-h-48 overflow-y-auto">
                                    ...
                                    {locations.map((location) => (
                                        <Button
                                            key={location}
                                            variant="ghost"
                                            className={`w-full justify-start ${selectedLocation === location ? "bg-accent" : ""
                                                }`}
                                            onClick={() => handleLocationSelect(location)}
                                        >
                                            {location}
