...
## ⏳ Features Pending Backend Support (Updated Nov 14, 2025)

### 1. Categories and Regions Endpoints ⚠️ CRITICAL
...
**Frontend Status**: ✅ Service created, graceful fallback  
**Impact**: Users can't select categories/regions during registration  

---

### 2. Company Reviews Endpoint ⚠️ CRITICAL
**Status**: Missing  
**Required**: `GET /api/companies/{id}/reviews/`  
**Frontend Status**: ✅ Shows count, informative message  
...
**Frontend Status**: ⚠️ Shows owner_email only  
...
- ��� 7 Critical backend issues  
- ��� 5 Backend improvements
- ��� 12+ Frontend improvements (can do now)
- ��� Testing needs & priorities
